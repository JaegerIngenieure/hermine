...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 08. Jun 2018 um 19:43
...
INSERT INTO items (name,gridX,gridY,structure,category,`comment`,creator,projectRef,refKey)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_project` (IN `_projectId` INT, IN `_projectName` VARCHAR(255), IN `_comment` TEXT, IN `_category` VARCHAR(255), IN `_gridX` VARCHAR(10), IN `_gridY` VARCHAR(10), IN `_storage` VARCHAR(255))  BEGIN
UPDATE projects SET
...
INSERT INTO `users` (`personId`, `userId`, `username`, `password`, `isActive`, `isAdmin`, `permissions`) VALUES
(1, 1, 'pwerner', '$2y$12$.bwKG.nqn/HtirQMcyHZge5UWdEUVAAgRE7gLdyW6eowaRwHGKhYG', 1, 1, '{\"auth\":\"100\",\"items\":\"100\",\"projects\":\"100\"}'),
(2, 2, 'tperson', '$2y$12$.ELjCEr7V8DORnlUFcM2XucX5Kc4ulxJaqvWW1AoOqap.OT3lQPm.', 1, 1, '{\"auth\":\"100\",\"items\":\"100\",\"projects\":\"100\"}'),
(3, 3, 'kamü', '$2y$12$YJeDrr3cCpOunKyLNGzHb.i8majzZsTAQyK/XHJC54wIP7S1lE5Nq', 1, 1, '{\"auth\":\"90\",\"items\":\"90\",\"projects\":\"90\"}');
...
--
ALTER TABLE `historyentries`
  MODIFY `historyEntryId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
